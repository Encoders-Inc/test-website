    ...
    <section className="hero">
      <Fade bottom>
        <div className="w-full lg:w-1/2 xl:pl-12 sm:pr-2 mt-8">
          <h1 className="text-5xl sm:text-6xl font-bold leading-tight mb-5 hero-text">
          ...
          <Button
            href="/project"
            type="link"
            className="flex w-71 h-18 items-center px-14 py-5 text-white text-xl  rounded-lg shadow-2xl hover:bg-dark-theme-purple transition duration-200 see-work"
          >
            See Our Work
            <svg
